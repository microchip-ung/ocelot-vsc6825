...
#define  VTSS_M_QSYS_SYSTEM_PORT_MODE_DEQUEUE_DIS  VTSS_BIT(1)
...
#define  VTSS_M_QSYS_SYSTEM_PORT_MODE_DEQUEUE_LATE  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_SYSTEM_SWITCH_PORT_MODE_PORT_ENA  VTSS_BIT(14)
...
#define  VTSS_M_QSYS_SYSTEM_SWITCH_PORT_MODE_YEL_RSRVD  VTSS_BIT(10)
...
#define  VTSS_M_QSYS_SYSTEM_SWITCH_PORT_MODE_INGRESS_DROP_MODE  VTSS_BIT(9)
...
#define  VTSS_M_QSYS_SYSTEM_SWITCH_PORT_MODE_TX_PFC_MODE  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_TX_GREEN_CNT_MODE  VTSS_BIT(5)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_TX_YELLOW_CNT_MODE  VTSS_BIT(4)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_DROP_GREEN_CNT_MODE  VTSS_BIT(3)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_DROP_YELLOW_CNT_MODE  VTSS_BIT(2)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_DROP_COUNT_ONCE  VTSS_BIT(1)
...
#define  VTSS_M_QSYS_SYSTEM_STAT_CNT_CFG_DROP_COUNT_EGRESS  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_TIMED_FRAME_DB_TIMED_FRAME_ENTRY_TFRM_VLD  VTSS_BIT(20)
...
#define  VTSS_M_QSYS_TIMED_FRAME_DB_TIMED_FRAME_ENTRY_TFRM_TM_T  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_TIMED_FRAME_CFG_TFRM_MISC_TIMED_CANCEL_1SHOT  VTSS_BIT(8)
...
#define  VTSS_M_QSYS_TIMED_FRAME_CFG_TFRM_MISC_TIMED_SLOT_MODE_MC  VTSS_BIT(7)
...
// Peter, 2016/10/27. Add for parsing RES_CFG
#define  VTSS_F_QSYS_RES_CTRL_RES_CFG_WM_MULTIPLIER_UNIT(x) VTSS_ENCODE_BITFIELD(x,8,1)
#define  VTSS_M_QSYS_RES_CTRL_RES_CFG_WM_MULTIPLIER_UNIT    VTSS_ENCODE_BITMASK(8,1)
#define  VTSS_X_QSYS_RES_CTRL_RES_CFG_WM_MULTIPLIER_UNIT(x) VTSS_EXTRACT_BITFIELD(x,8,1)
#define  VTSS_F_QSYS_RES_CTRL_RES_CFG_WM_VALE(x)            VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_QSYS_RES_CTRL_RES_CFG_WM_VALE               VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_QSYS_RES_CTRL_RES_CFG_WM_VALE(x)            VTSS_EXTRACT_BITFIELD(x,0,8)
...
#define  VTSS_M_QSYS_HSCH_EIR_CFG_EIR_MARK_ENA  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_HSCH_SE_CFG_SE_RR_ENA    VTSS_BIT(5)
...
#define  VTSS_M_QSYS_HSCH_SE_CFG_SE_AVB_ENA   VTSS_BIT(4)
...
#define  VTSS_M_QSYS_HSCH_SE_CFG_SE_EXC_ENA   VTSS_BIT(1)
...
#define  VTSS_M_QSYS_HSCH_SE_CFG_SE_EXC_FWD   VTSS_BIT(0)
...
#define  VTSS_M_QSYS_HSCH_SE_CONNECT_SE_TERMINAL  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_HSCH_SE_DLB_SENSE_SE_DLB_PRIO_ENA  VTSS_BIT(2)
...
#define  VTSS_M_QSYS_HSCH_SE_DLB_SENSE_SE_DLB_SPORT_ENA  VTSS_BIT(1)
...
#define  VTSS_M_QSYS_HSCH_SE_DLB_SENSE_SE_DLB_DPORT_ENA  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_HSCH_SE_STATE_SE_WAS_YEL  VTSS_BIT(0)
...
#define  VTSS_M_QSYS_HSCH_MISC_HSCH_MISC_CFG_SE_CONNECT_VLD  VTSS_BIT(8)
...
#define  VTSS_M_QSYS_HSCH_MISC_HSCH_MISC_CFG_LEAK_DIS  VTSS_BIT(2)
...
#define  VTSS_M_QSYS_HSCH_MISC_HSCH_MISC_CFG_QSHP_EXC_ENA  VTSS_BIT(1)
...
#define  VTSS_M_QSYS_HSCH_MISC_HSCH_MISC_CFG_PFC_BYP_UPD  VTSS_BIT(0)
