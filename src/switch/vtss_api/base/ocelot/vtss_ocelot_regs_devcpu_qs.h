 ...
 * encoding.
 * Note: The encoding is presented in little endian format, if swapping is
 * used (see DEVCPU_QS::XTR_GRP_CFG.BYTE_SWAP), then the special values are
 * swapped as well. I.e. a little endian CPU using BYTE_SWAP=1 has to look
 * for "0x0n000080" instead of "0x8000000n".
 * The position of the unused/valid bytes follows the endianness encoding
 * and swapping.
 *
 * \details 
 ...
 *
 * Field: ::VTSS_DEVCPU_QS_XTR_XTR_RD . DATA
 */
 ...
 * Note :  PRUNE_SIZE includes the IFH when this present in the frame.
 *
 * \details 
 * 0 : No pruning
 ...
 * Note the queue will continue to be flushed until this field is cleared
 * by SW. The flushing will automatically stop on frame boundary so OQS is
 * allowed to transmit to the CPU queue during flushing.
 *
 * \details 
 * 0: No action
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_QS_XTR_XTR_CFG . DP_WM
 */
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_QS_XTR_XTR_CFG . SCH_WM
 */
 ...
 *
 * Field: ::VTSS_DEVCPU_QS_XTR_XTR_CFG . OFLW_ERR_STICKY
 */
 ...
 * frame data currently injected into the chip.
 * Reading from this register returns 0.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_QS_INJ_INJ_WR . DATA
 */
 ...
 *
 * Field: ::VTSS_DEVCPU_QS_INJ_VTSS_DBG . FRM_CNT
 */
