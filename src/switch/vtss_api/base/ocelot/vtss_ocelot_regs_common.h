...
#define VTSS_TO_VCAP_ES0   VTSS_IO_OFFSET2(0x00040000) /*!< Base offset for target VCAP_ES0 */
#define VTSS_TO_ES0        VTSS_IO_OFFSET2(0x00040000) /*!< Base offset for target ES0 */


#define VTSS_TO_VCAP_IS1   VTSS_IO_OFFSET2(0x00050000) /*!< Base offset for target VCAP_IS1 */
#define VTSS_TO_VCAP_IS2   VTSS_IO_OFFSET2(0x00060000) /*!< Base offset for target VCAP_IS2 */
...
#define VTSS_TO_MACRO_CTRL VTSS_IO_OFFSET2(0x000d0000) /*!< Base offset for target MACRO_CTRL */
