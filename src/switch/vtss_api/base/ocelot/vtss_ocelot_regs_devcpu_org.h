...
#ifndef _VTSS_OCELOT_REGS_DEVCPU_ORG_H_
#define _VTSS_OCELOT_REGS_DEVCPU_ORG_H_
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_IF_CFGSTAT_IF_STAT(x)  VTSS_ENCODE_BITFIELD(!!(x),16,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_IF_CFGSTAT_IF_STAT  VTSS_BIT(16)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_IF_CFGSTAT_IF_STAT(x)  VTSS_EXTRACT_BITFIELD(x,16,1)
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_BLOCKING_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_BLOCKING_ENA  VTSS_BIT(2)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_BLOCKING_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_DROP_MODE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_DROP_MODE_ENA  VTSS_BIT(1)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_DROP_MODE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_FAST_WR(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_FAST_WR  VTSS_BIT(0)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_ORG_CFG_FAST_WR(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_GPR . GPR
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_GPR_GPR(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_GPR_GPR     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_GPR_GPR(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_SET . MAILBOX_SET
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_SET_MAILBOX_SET(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_SET_MAILBOX_SET     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_SET_MAILBOX_SET(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_CLR . MAILBOX_CLR
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_CLR_MAILBOX_CLR(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_CLR_MAILBOX_CLR     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_CLR_MAILBOX_CLR(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_MAILBOX . MAILBOX
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_MAILBOX(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_MAILBOX     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_MAILBOX_MAILBOX(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_SEMA0_SEMA0(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_SEMA0_SEMA0  VTSS_BIT(0)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_SEMA0_SEMA0(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * \details 
 * 0: Semaphore is free.
 * 1: VCore System owns semaphore
 * 2: VRAP owns semaphore
 * 4: SI owns smaphore
 * 8: MIIM owns semaphore
 *
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_SEMA0_OWNER . SEMA0_OWNER
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_SEMA0_OWNER_SEMA0_OWNER(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_SEMA0_OWNER_SEMA0_OWNER     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_SEMA0_OWNER_SEMA0_OWNER(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_SEMA1_SEMA1(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_SEMA1_SEMA1  VTSS_BIT(0)
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_SEMA1_SEMA1(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * 8: MIIM owns semaphore
 *
 * Field: ::VTSS_DEVCPU_ORG_DEVCPU_ORG_SEMA1_OWNER . SEMA1_OWNER
 */
#define  VTSS_F_DEVCPU_ORG_DEVCPU_ORG_SEMA1_OWNER_SEMA1_OWNER(x)  (x)
#define  VTSS_M_DEVCPU_ORG_DEVCPU_ORG_SEMA1_OWNER_SEMA1_OWNER     0xffffffff
#define  VTSS_X_DEVCPU_ORG_DEVCPU_ORG_SEMA1_OWNER_SEMA1_OWNER(x)  (x)


#endif /* _VTSS_OCELOT_REGS_DEVCPU_ORG_H_ */
