...
#define  VTSS_M_ANA_ANA_ADVLEARN_VLAN_CHK     VTSS_BIT(11)
...
#define  VTSS_M_ANA_ANA_ANAGEFIL_B_DOM_EN     VTSS_BIT(22)
...
#define  VTSS_M_ANA_ANA_ANAGEFIL_B_DOM_VAL    VTSS_BIT(21)
...
#define  VTSS_M_ANA_ANA_ANAGEFIL_AGE_LOCKED   VTSS_BIT(20)
...
#define  VTSS_M_ANA_ANA_ANAGEFIL_VID_EN       VTSS_BIT(13)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_MSTI_DROP    VTSS_BIT(27)
#define  VTSS_X_ANA_ANA_ANEVENTS_MSTI_DROP(x)  VTSS_EXTRACT_BITFIELD(x,27,1)

/** 
 * \brief
 * A frame was discarded due to an ACL rule.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_ANEVENTS . ACLKILL
 */
#define  VTSS_F_ANA_ANA_ANEVENTS_ACLKILL(x)   VTSS_ENCODE_BITFIELD(!!(x),26,1)
#define  VTSS_M_ANA_ANA_ANEVENTS_ACLKILL      VTSS_BIT(26)
#define  VTSS_X_ANA_ANA_ANEVENTS_ACLKILL(x)   VTSS_EXTRACT_BITFIELD(x,26,1)

/** 
 * \brief
 * An ACL action was taken.

 *
 * \details 
 * Field: ::VTSS_ANA_ANA_ANEVENTS . ACLUSED
 */
#define  VTSS_F_ANA_ANA_ANEVENTS_ACLUSED(x)   VTSS_ENCODE_BITFIELD(!!(x),25,1)
#define  VTSS_M_ANA_ANA_ANEVENTS_ACLUSED      VTSS_BIT(25)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_AUTOAGE      VTSS_BIT(24)
#define  VTSS_X_ANA_ANA_ANEVENTS_AUTOAGE(x)   VTSS_EXTRACT_BITFIELD(x,24,1)

/** 
 * \brief
 * A frame was parsed from a stackport with TTL=1.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_ANEVENTS . VS2TTL1
 */
#define  VTSS_F_ANA_ANA_ANEVENTS_VS2TTL1(x)   VTSS_ENCODE_BITFIELD(!!(x),23,1)
#define  VTSS_M_ANA_ANA_ANEVENTS_VS2TTL1      VTSS_BIT(23)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_STORM_DROP   VTSS_BIT(22)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_LEARN_DROP   VTSS_BIT(21)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_AGED_ENTRY   VTSS_BIT(20)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_CPU_LEARN_FAILED  VTSS_BIT(19)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_AUTO_LEARN_FAILED  VTSS_BIT(18)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_LEARN_REMOVE  VTSS_BIT(17)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_AUTO_LEARNED  VTSS_BIT(16)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_AUTO_MOVED   VTSS_BIT(15)
#define  VTSS_X_ANA_ANA_ANEVENTS_AUTO_MOVED(x)  VTSS_EXTRACT_BITFIELD(x,15,1)

/** 
 * \brief
 * A frame was not transmitted to any ports.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_ANEVENTS . DROPPED
 */
#define  VTSS_F_ANA_ANA_ANEVENTS_DROPPED(x)   VTSS_ENCODE_BITFIELD(!!(x),14,1)
#define  VTSS_M_ANA_ANA_ANEVENTS_DROPPED      VTSS_BIT(14)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_CLASSIFIED_DROP  VTSS_BIT(13)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_CLASSIFIED_COPY  VTSS_BIT(12)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_VLAN_DISCARD  VTSS_BIT(11)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_FWD_DISCARD  VTSS_BIT(10)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_MULTICAST_FLOOD  VTSS_BIT(9)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_UNICAST_FLOOD  VTSS_BIT(8)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_DEST_KNOWN   VTSS_BIT(7)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_BUCKET3_MATCH  VTSS_BIT(6)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_BUCKET2_MATCH  VTSS_BIT(5)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_BUCKET1_MATCH  VTSS_BIT(4)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_BUCKET0_MATCH  VTSS_BIT(3)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_CPU_OPERATION  VTSS_BIT(2)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_DMAC_LOOKUP  VTSS_BIT(1)
...
#define  VTSS_M_ANA_ANA_ANEVENTS_SMAC_LOOKUP  VTSS_BIT(0)
...
/** 
 * \brief Storm policer configuration per storm policer
 *
 * \details
 * 0: UC storm policer
 * 1: BC storm policer
...
#define  VTSS_M_ANA_ANA_STORMLIMIT_CFG_STORM_UNIT  VTSS_BIT(2)
...
#define  VTSS_M_ANA_ANA_AUTOAGE_AGE_FAST      VTSS_BIT(21)
...
/** 
 * \brief
 * Enable setting of the AGED_FLAG for locked entries in the MAC table when
 * doing an age scan. Locked entries are never removed but the AGED_FLAG
 * can be used to indicate activity for the MAC address.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_AUTOAGE . AUTOAGE_LOCKED
 */
#define  VTSS_F_ANA_ANA_AUTOAGE_AUTOAGE_LOCKED(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_ANA_ANA_AUTOAGE_AUTOAGE_LOCKED  VTSS_BIT(0)
...
/** 
 * \brief
 * When set, the MAC table is reduced to 256 entries (64 rows of 4
 * entries).
 *
 * \details 
...
#define  VTSS_M_ANA_ANA_MACTOPTIONS_REDUCED_TABLE  VTSS_BIT(1)
...
#define  VTSS_M_ANA_ANA_MACTOPTIONS_SHADOW    VTSS_BIT(0)
...
/** 
 * \brief
 * Number of discarded learn requests due to MAC table overflow (collisions
 * or MAC table entry limits).
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_LEARNDISC . LEARNDISC
 */
...
#define  VTSS_M_ANA_ANA_AGENCTRL_IGNORE_DMAC_FLAGS  VTSS_BIT(11)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_IGNORE_SMAC_FLAGS  VTSS_BIT(10)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_FLOOD_SPECIAL  VTSS_BIT(9)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_FLOOD_IGNORE_VLAN  VTSS_BIT(8)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_MIRROR_CPU   VTSS_BIT(7)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_LEARN_CPU_COPY  VTSS_BIT(6)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_LEARN_SRC_KILL  VTSS_BIT(5)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_LEARN_IGNORE_VLAN  VTSS_BIT(4)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_CPU_CPU_KILL_ENA  VTSS_BIT(3)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_GREEN_COUNT_MODE  VTSS_BIT(2)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_YELLOW_COUNT_MODE  VTSS_BIT(1)
...
#define  VTSS_M_ANA_ANA_AGENCTRL_RED_COUNT_MODE  VTSS_BIT(0)
...
/** 
 * \brief sFlow sampling configuration per switch port
 *
 * \details
 * Register: \a ANA:ANA:SFLOW_CFG
 *
 * @param ri Replicator: x_GAZ_CORE_SPORT_CNT (??), 0-11
 */
...
#define  VTSS_M_ANA_ANA_SFLOW_CFG_SF_SAMPLE_RX  VTSS_BIT(1)
...
#define  VTSS_M_ANA_ANA_SFLOW_CFG_SF_SAMPLE_TX  VTSS_BIT(0)
 ...
 *
 * @param ri Replicator: x_GAZ_CORE_DPORT_CNT (??), 0-12
 */
#define VTSS_ANA_ANA_PORT_MODE(ri)           VTSS_IOREG(VTSS_TO_ANA,0x2420 + (ri))

/** 
 * \brief
 * Maximum number of tags to parse looking for higher layer protocol
 * information.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_PORT_MODE . VLAN_PARSE_CFG
 */
...
#define  VTSS_M_ANA_ANA_PORT_MODE_L3_PARSE_CFG  VTSS_BIT(0)
 ...
 * 80-90: A mask is applied based on source port analysis
 * 
...
/** 
 * \brief
 * Lower 32 MAC address bits used in MAC table operations through
 * MACACCESS.
 *
 * \details 
 * Field: ::VTSS_ANA_ANA_TABLES_MACLDATA . MACLDATA
 */
 ...
 * mode.
 *     Direct mode (read):
 *     With MACACCESS.VALID cleared, the entry pointed to by
 * MACTINDX.M_INDEX (row) and MACTINDX.BUCKET (column) is read.
 *     Indirect mode (lookup):
 *     With MACACCESS.VALID set, the entry pointed to by (MAC, VID) in the
 * MACHDATA and MACLDATA is read.
 *     
 *     111 - WRITE
 *     Write entry. Address of the entry is specified in MACTINDX.M_INDEX
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_B_DOM  VTSS_BIT(18)
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_MAC_CPU_COPY  VTSS_BIT(15)
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_SRC_KILL  VTSS_BIT(14)
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_IGNORE_VLAN  VTSS_BIT(13)
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_AGED_FLAG  VTSS_BIT(12)
...
#define  VTSS_M_ANA_ANA_TABLES_MACACCESS_VALID  VTSS_BIT(11)
...
/** 
 * \brief
 * The index selects one of the 1024 MAC table rows. Within a row the entry
 ...
 * 
 *   01 - READ:
 *   The VLAN table entry set in VLANTIDX.V_INDEX is returned in
 * VLANACCESS.VLAN_PORT_MASK and the VLAN flags in VLANTIDX.
 * 
 *   10 - WRITE:
 *   The VLAN table entry pointed to by VLANTIDX.V_INDEX is updated with
 * VLANACCESS.VLAN_PORT_MASK and the VLAN flags in VLANTIDX.
 * 
 *   11 - INIT:
...
/** 
 * \brief
 * If set, a VLAN is a private VLAN. See ISOLATED_PORTS.ISOL_PORTS for
 * details.
 *
 * \details 
...
#define  VTSS_M_ANA_ANA_TABLES_VLANTIDX_VLAN_PRIV_VLAN  VTSS_BIT(15)
...
#define  VTSS_M_ANA_ANA_TABLES_VLANTIDX_VLAN_LEARN_DISABLED  VTSS_BIT(14)
...
#define  VTSS_M_ANA_ANA_TABLES_VLANTIDX_VLAN_MIRROR  VTSS_BIT(13)
...
#define  VTSS_M_ANA_ANA_TABLES_VLANTIDX_VLAN_SRC_CHK  VTSS_BIT(12)
 ...
 * 
 *   01 - READ:
 *   The ISDX table entry set in ISDXTIDX.ISDX_INDEX is returned in
 * ISDXACCESS.ISDX_PORT_MASK and ISDXTIDX.
 * 
 *   10 - WRITE:
 *   The ISDX table entry pointed to by ISDXTIDX.ISDX_INDEX is updated with
 * ISDXACCESS.ISDX_PORT_MASK and ISDXTIDX
 * 
 *   11 - INIT:
...
/** 
 * \brief
 * Index of associated MSTP instance, see ANA::MSTI_STATE.
 *
 * \details 
...
#define  VTSS_M_ANA_ANA_TABLES_ISDXTIDX_ISDX_ES0_KEY_ENA  VTSS_BIT(14)
...
#define  VTSS_M_ANA_ANA_TABLES_ISDXTIDX_ISDX_FORCE_ENA  VTSS_BIT(10)
...
/** 
 * \brief MAC table entry limits per switch port
 *
 * \details
...
/** 
 * \brief
 * Bit vector with current use of PTP timestamp identifiers 32 through 63.
 * Timestamp identifier is 63 is reserved for signaling that no identifiers
 * are available. A timestamp identifier is released by setting the
 * corresponding bit.
 *
 * \details 
 * Bit 0: Timestamp identifier 32
 * ...
 * Bit 31: Timestamp identifier 63.
 *
 * Field: ::VTSS_ANA_ANA_TABLES_PTP_ID_HIGH . PTP_ID_HIGH
 */
...
/** 
 * \brief
 * Bit vector with current use of PTP timestamp identifiers 0 through 31. A
 * timestamp identifier is released by setting the corresponding bit.
 *
 * \details 
 * Bit 0: Timestamp identifier 0
 * ...
 * Bit 31: Timestamp identifier 31.
 *
 * Field: ::VTSS_ANA_ANA_TABLES_PTP_ID_LOW . PTP_ID_LOW
 */
 ...
 *
 * @param ri Replicator: x_NUM_UPM_CNT (??), 0-255
 */
#define VTSS_ANA_OAM_UPM_LM_CNT_OAM_UPM_LM_CNT(ri)  VTSS_IOREG(VTSS_TO_ANA,0x1f00 + (ri))

/** 
 * \brief
 * Up-MEP OAM service Tx loss measurement counters.
 *
 * \details 
 * Field: ::VTSS_ANA_OAM_UPM_LM_CNT_OAM_UPM_LM_CNT . OAM_UPM_LM_CNT_VAL
 */
 ...
 *
 * @param gi Replicator: x_ANA_PORT_CNT (??), 0-11
 */
#define VTSS_ANA_PORT_VLAN_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_ANA,0x1c00,gi,64,0,0)

/** 
 * \brief
 * Use LSB of classified VID value as ISDX
 *
 * \details 
 * Field: ::VTSS_ANA_PORT_VLAN_CFG . VLAN_VID_AS_ISDX
 */
#define  VTSS_F_ANA_PORT_VLAN_CFG_VLAN_VID_AS_ISDX(x)  VTSS_ENCODE_BITFIELD(!!(x),21,1)
#define  VTSS_M_ANA_PORT_VLAN_CFG_VLAN_VID_AS_ISDX  VTSS_BIT(21)
...
#define  VTSS_M_ANA_PORT_VLAN_CFG_VLAN_AWARE_ENA  VTSS_BIT(20)
 ...
 * 3: Disable rewriting of VLAN tags and DSCP value. The rewriter can still
 * update the FCS.
...
#define  VTSS_M_ANA_PORT_VLAN_CFG_VLAN_INNER_TAG_ENA  VTSS_BIT(17)
...
#define  VTSS_M_ANA_PORT_VLAN_CFG_VLAN_TAG_TYPE  VTSS_BIT(16)
...
#define  VTSS_M_ANA_PORT_VLAN_CFG_VLAN_DEI    VTSS_BIT(15)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_UNTAGGED_ENA  VTSS_BIT(6)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_S_TAGGED_ENA  VTSS_BIT(5)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_C_TAGGED_ENA  VTSS_BIT(4)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_PRIO_S_TAGGED_ENA  VTSS_BIT(3)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_PRIO_C_TAGGED_ENA  VTSS_BIT(2)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_NULL_MAC_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_PORT_DROP_CFG_DROP_MC_SMAC_ENA  VTSS_BIT(0)
...
#define  VTSS_M_ANA_PORT_QOS_CFG_QOS_DSCP_ENA  VTSS_BIT(4)
...
#define  VTSS_M_ANA_PORT_QOS_CFG_QOS_PCP_ENA  VTSS_BIT(3)
...
#define  VTSS_M_ANA_PORT_QOS_CFG_DSCP_TRANSLATE_ENA  VTSS_BIT(2)
...
#define  VTSS_M_ANA_PORT_VCAP_CFG_S1_ENA      VTSS_BIT(14)
...
/** 
 * \brief VCAP S1 key configuration per S1 lookup
 *
 * \details
 ...
 *
 * \details 
 * Field: ::VTSS_ANA_PORT_VCAP_S2_CFG . S2_UDP_PAYLOAD_ENA
 */
 ...
 *
 * \details 
 * Field: ::VTSS_ANA_PORT_VCAP_S2_CFG . S2_ETYPE_PAYLOAD_ENA
 */
...
#define  VTSS_M_ANA_PORT_VCAP_S2_CFG_S2_ENA   VTSS_BIT(14)
...
#define  VTSS_M_ANA_PORT_QOS_PCP_DEI_MAP_CFG_DP_PCP_DEI_VAL  VTSS_BIT(3)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_VRAP_REDIR_ENA  VTSS_BIT(7)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_MLD_REDIR_ENA  VTSS_BIT(6)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_IGMP_REDIR_ENA  VTSS_BIT(5)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_IPMC_CTRL_COPY_ENA  VTSS_BIT(4)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_SRC_COPY_ENA  VTSS_BIT(3)
#define  VTSS_X_ANA_PORT_CPU_FWD_CFG_CPU_SRC_COPY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,3,1)

/** 
 * \brief
 * If set, All LANs Bridge Management Group Address frames (DMAC =
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_ALLBRIDGE_DROP_ENA  VTSS_BIT(2)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_ALLBRIDGE_REDIR_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_PORT_CPU_FWD_CFG_CPU_OAM_ENA  VTSS_BIT(0)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_SRC_MIRROR_ENA  VTSS_BIT(15)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LIMIT_DROP  VTSS_BIT(14)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LIMIT_CPU   VTSS_BIT(13)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LOCKED_PORTMOVE_DROP  VTSS_BIT(12)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LOCKED_PORTMOVE_CPU  VTSS_BIT(11)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LEARNDROP   VTSS_BIT(10)
 ...
 * CPU extraction queue specified in CPUQ_CFG.CPUQ_LRN. Note that if
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LEARNCPU    VTSS_BIT(9)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LEARNAUTO   VTSS_BIT(8)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LEARN_ENA   VTSS_BIT(7)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_RECV_ENA    VTSS_BIT(6)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_USE_B_DOM_TBL  VTSS_BIT(1)
...
#define  VTSS_M_ANA_PORT_PORT_CFG_LSR_MODE    VTSS_BIT(0)
 ...
 * ALLBRIGDE), which are copied to the CPU are not policed by any policers.
 *
 * \details 
...
#define  VTSS_M_ANA_PORT_POL_CFG_POL_CPU_REDIR_8021  VTSS_BIT(19)
...
#define  VTSS_M_ANA_PORT_POL_CFG_POL_CPU_REDIR_IP  VTSS_BIT(18)
...
#define  VTSS_M_ANA_PORT_POL_CFG_PORT_POL_ENA  VTSS_BIT(17)
...
#define  VTSS_M_ANA_PORT_PTP_CFG_PTP_BACKPLANE_MODE  VTSS_BIT(0)
...
/** 
 * \brief
 * Delay optionally subtracted from the frame's receive timestamp. This can
 * for instance be a peer-to-peer link delay or a delay due to asymmetry.
 * The subtraction is enabled through IS2 action REW_OP for one-step PTP.
 * Unit is ns. Value is signed.
 *
 * \details 
 * Field: ::VTSS_ANA_PORT_PTP_DLY1_CFG . PTP_DLY1_VAL
 */
 ...
 * for instance be a peer-to-peer link delay or a delay due to asymmetry.
 * The subtraction is enabled through IS2 action REW_OP for one-step PTP.
 * This is not applicable if the ingress port is in backplane mode. Unit is
 * ns. Value is signed.
 *
 * \details 
 * Field: ::VTSS_ANA_PORT_PTP_DLY2_CFG . PTP_DLY2_VAL
 */
 ...
 *
 * @param gi Replicator: x_GAZ_CORE_FPORT_CNT (??), 0-10
 */
 ...
 *
 * \details
 * Register: \a ANA:PFC:PFC_TIMER
 *
 * @param gi Replicator: x_GAZ_CORE_FPORT_CNT (??), 0-10
 * @param ri Replicator: x_GAZ_CORE_PRIO_CNT (??), 0-7
 */
 ...
 *
 * Field: ::VTSS_ANA_PFC_PFC_TIMER . PFC_TIMER_VAL
 */
 ...
 *
 * @param gi Replicator: x_GAZ_CORE_ISDX_COUNT (??), 0-255
 */
...
#define  VTSS_M_ANA_IPT_OAM_MEP_CFG_MEP_IDX_ENA  VTSS_BIT(0)
 ...
 * path protection group is selected by IPT.PPT_IDX from the ISDX
 * protection table. 
 * 
 ...
 *
 * Field: ::VTSS_ANA_PPT_PPT . PATH_STAT
 */
 ...
 * (ANA:PORT:PORT_CFG.USE_B_DOM_TBL=0). If FID_C_VAL=0 then FID_C_VAL=VID
 * is used instead.
 *
 * \details 
 ...
 * (ANA:PORT:PORT_CFG.USE_B_DOM_TBL=1). If FID_B_VAL=0 then FID_B_VAL=VID
 * is used instead.
 *
 * \details 
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_RND_ENA  VTSS_BIT(7)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_DMAC_ENA  VTSS_BIT(6)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_SMAC_ENA  VTSS_BIT(5)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_IP6_FLOW_LBL_ENA  VTSS_BIT(4)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_IP6_TCPUDP_ENA  VTSS_BIT(3)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_IP4_SIPDIP_ENA  VTSS_BIT(2)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_IP4_TCPUDP_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_COMMON_AGGR_CFG_AC_ISDX_ENA  VTSS_BIT(0)
...
/** 
 * \brief
 * CPU extraction queue used for All LANs Bridge Management Group Address
 * frames (DMAC = 01-80-C2-00-00-10).
 *
 * \details 
...
#define  VTSS_M_ANA_COMMON_DSCP_CFG_DP_DSCP_VAL  VTSS_BIT(11)
...
#define  VTSS_M_ANA_COMMON_DSCP_CFG_DSCP_TRUST_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_COMMON_DSCP_CFG_DSCP_REWR_ENA  VTSS_BIT(0)
...
#define  VTSS_M_ANA_COMMON_VRAP_CFG_VRAP_VLAN_AWARE_ENA  VTSS_BIT(12)
...
/** 
 * \brief
 * The frame's VRAP header (4 bytes after EPID) is matched against
 * VRAP_HDR_DATA, except for bits don't cared by VRAP_HDR_MASK.

 *
 * \details 
 * Field: ::VTSS_ANA_COMMON_VRAP_HDR_DATA . VRAP_HDR_DATA
 */
 ...
 *
 * \details 
 * Field: ::VTSS_ANA_COMMON_VRAP_HDR_MASK . VRAP_HDR_MASK
 */
...
#define  VTSS_M_ANA_COMMON_DISCARD_CFG_DROP_TAGGING_ISDX0  VTSS_BIT(3)
...
#define  VTSS_M_ANA_COMMON_DISCARD_CFG_DROP_CTRLPROT_ISDX0  VTSS_BIT(2)
...
#define  VTSS_M_ANA_COMMON_DISCARD_CFG_DROP_TAGGING_S2_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_COMMON_DISCARD_CFG_DROP_CTRLPROT_S2_ENA  VTSS_BIT(0)
...
#define  VTSS_M_ANA_COMMON_FID_CFG_VID_MC_ENA  VTSS_BIT(0)
 ...
 *
 * @param gi Replicator: x_GAZ_CORE_POL_COUNT (??), 0-383
 */
#define VTSS_ANA_POL_POL_PIR_CFG(gi)         VTSS_IOREG_IX(VTSS_TO_ANA,0x1000,gi,8,0,0)

/** 
 * \brief
 * Excess information rate (EIR). Unit is 33 1/3 kbps.
 *
 * \details 
...
/** 
 * \brief
 * Committed information rate (CIR). Unit is 33 1/3 kbps.
 *
 * \details 
...
/** 
 * \brief
 * Committed burst size (CBS). Maximum allowed value is 60. Unit is 4
 * kilobytes.
 *
 * \details 
 ...
 * 2. Frame rate. Measure frames with rate unit = 33 1/3 frames per second
 * and burst unit = 32.8 frames.
 * 3: Frame rate. Measure frames with rate unit = 1/3 frame per second
 * burst unit = 0.3 frames.
 *
...
#define  VTSS_M_ANA_POL_POL_MODE_CFG_DLB_COUPLED  VTSS_BIT(2)
...
#define  VTSS_M_ANA_POL_POL_MODE_CFG_CIR_ENA  VTSS_BIT(1)
...
#define  VTSS_M_ANA_POL_POL_MODE_CFG_OVERSHOOT_ENA  VTSS_BIT(0)
...
/** 
 * \brief Internal policer state
 *
 * \details
 * Register: \a ANA:POL:POL_STATE
 *
 * @param gi Replicator: x_GAZ_CORE_POL_COUNT (??), 0-383
 */
 ...
 *
 * \details 
 * Field: ::VTSS_ANA_POL_POL_STATE . LEAK_TIME
 */
...
/** 
 * \brief Flow control configuration per front port
 *
 * \details
...
#define  VTSS_M_ANA_POL_MISC_POL_FLOWC_POL_FLOWC  VTSS_BIT(0)
...
/** 
 * \brief Common configuration for all policers
 *
 * \details
 * Register: \a ANA:POL_MISC:POL_MISC_CFG
 */
#define VTSS_ANA_POL_MISC_POL_MISC_CFG       VTSS_IOREG(VTSS_TO_ANA,0x22fc)

/** 
 * \brief
 * Keep all configured buckets closed.
 *
 * \details 
 * Field: ::VTSS_ANA_POL_MISC_POL_MISC_CFG . POL_CLOSE_ALL
 */
#define  VTSS_F_ANA_POL_MISC_POL_MISC_CFG_POL_CLOSE_ALL(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_ANA_POL_MISC_POL_MISC_CFG_POL_CLOSE_ALL  VTSS_BIT(1)
#define  VTSS_X_ANA_POL_MISC_POL_MISC_CFG_POL_CLOSE_ALL(x)  VTSS_EXTRACT_BITFIELD(x,1,1)

/** 
 * \brief
 * Disable leaking from the policers.
 *
 * \details 
 * Field: ::VTSS_ANA_POL_MISC_POL_MISC_CFG . POL_LEAK_DIS
 */
#define  VTSS_F_ANA_POL_MISC_POL_MISC_CFG_POL_LEAK_DIS(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_ANA_POL_MISC_POL_MISC_CFG_POL_LEAK_DIS  VTSS_BIT(0)
