 ...
 * It is possible to protect the VCore system (everything else than the
 ...
 * source. For example manual extraction data available interrupts can be
 ...
 * for data.
 * When using ECC mode, then the amount of random-access memory available
 * to an application is half of the physically attached memory.
 *
 * \details 
 ...
 * field is written to the register defined by bit [15:14].
 *
 * \details 
 ...
 * Bits 7 through 9 (OCD Calibration Program) of this register must be set
...
#define  VTSS_M_ICPU_CFG_MEMCTRL_MEMPHY_DFT_PHY_DLL_BYPASS  VTSS_BIT(0)
 ...
 * zero.
 * This counter can be written by software, or incremented automatically by
...
/** 
 * \brief
 * Set this field to make the FDMA emit FRM event for extraction channels
 * that are disabled because of LLP=NULL.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_FDMA_FDMA_GCFG . FRM_AT_OFF
 */
#define  VTSS_F_ICPU_CFG_FDMA_FDMA_GCFG_FRM_AT_OFF(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_ICPU_CFG_FDMA_FDMA_GCFG_FRM_AT_OFF  VTSS_BIT(12)
...
/** 
 * \brief
 * Set this field to disable initialization of the PCIe link.
 * By default the PCIe core will start up and try to achieve link when the
 * SERDES is started, by setting this field before starting the SERDES it
 * is possible to make changes to the PCIe configuration/registers prior to
 * linking with the root complex.
 *
 * \details 
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_TXRX_DETECT  VTSS_BIT(22)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_SDETCOM_PERM  VTSS_BIT(21)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_SDETCOM_DIS  VTSS_BIT(20)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_BEACON_FORCE  VTSS_BIT(19)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXRST_FORCE  VTSS_BIT(18)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXRST_VAL  VTSS_BIT(17)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_TXRST_FORCE  VTSS_BIT(16)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_TXRST_VAL  VTSS_BIT(15)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXSDET_XOR  VTSS_BIT(14)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXSDET_FORCE  VTSS_BIT(13)
 ...
 * only, the PCS handles inversion internally whenever this is requested by
 * the PCIe MAC.
 *
 * \details 
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXINV_ENA  VTSS_BIT(12)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_RXSWAP_ENA  VTSS_BIT(11)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_TXSWAP_ENA  VTSS_BIT(10)
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_IDLE_DATA_DIS  VTSS_BIT(9)
#define  VTSS_X_ICPU_CFG_PCIE_PCIEPCS_CFG_IDLE_DATA_DIS(x)  VTSS_EXTRACT_BITFIELD(x,9,1)

/** 
 * \brief
 * Set this field to disable support for outband idle signaling.
 *
 * \details 
...
#define  VTSS_M_ICPU_CFG_PCIE_PCIEPCS_CFG_IDLE_DIS  VTSS_BIT(8)
 ...
 * 4: Delay IDLE by 3 symbols.
 * 5: Delay IDLE by 4 symbols.
 * 6: Delay IDLE by 5 symbols.
...
/** 
 * \brief
 * Set this field to disable outband PCIe beacon signaling when attempting
...
/** 
 * \brief
 * Set to swap endianness of data injected to the MANUAL_INJ region. The
...
/** 
 * \brief
 * Set to byte-swap endianness of data extracted from the MANUAL_XTR
 * region. The manual extraction status word is never swapped.
 *
 * \details 
