...
#define  VTSS_M_UART_UART_IER_PTIME           VTSS_BIT(7)
...
#define  VTSS_M_UART_UART_IER_EDSSI           VTSS_BIT(3)
...
#define  VTSS_M_UART_UART_IER_ELSI            VTSS_BIT(2)
...
#define  VTSS_M_UART_UART_IER_ETBEI           VTSS_BIT(1)
...
#define  VTSS_M_UART_UART_IER_ERBFI           VTSS_BIT(0)
...
#define  VTSS_M_UART_UART_IIR_FCR_XFIFOR      VTSS_BIT(2)
...
#define  VTSS_M_UART_UART_IIR_FCR_RFIFOR      VTSS_BIT(1)
...
#define  VTSS_M_UART_UART_IIR_FCR_FIFOE       VTSS_BIT(0)
...
#define  VTSS_M_UART_UART_LCR_DLAB            VTSS_BIT(7)
...
#define  VTSS_M_UART_UART_LCR_BC              VTSS_BIT(6)
...
#define  VTSS_M_UART_UART_LCR_EPS             VTSS_BIT(4)
...
#define  VTSS_M_UART_UART_LCR_PEN             VTSS_BIT(3)
...
#define  VTSS_M_UART_UART_LCR_STOP            VTSS_BIT(2)
...
#define  VTSS_M_UART_UART_MCR_AFCE            VTSS_BIT(5)
...
#define  VTSS_M_UART_UART_MCR_LB              VTSS_BIT(4)
...
#define  VTSS_M_UART_UART_MCR_RTS             VTSS_BIT(1)
...
#define  VTSS_M_UART_UART_LSR_RFE             VTSS_BIT(7)
...
#define  VTSS_M_UART_UART_LSR_TEMT            VTSS_BIT(6)
...
#define  VTSS_M_UART_UART_LSR_THRE            VTSS_BIT(5)
...
#define  VTSS_M_UART_UART_LSR_BI              VTSS_BIT(4)
...
#define  VTSS_M_UART_UART_LSR_FE              VTSS_BIT(3)
...
#define  VTSS_M_UART_UART_LSR_PE              VTSS_BIT(2)
...
#define  VTSS_M_UART_UART_LSR_OE              VTSS_BIT(1)
...
#define  VTSS_M_UART_UART_LSR_DR              VTSS_BIT(0)
...
#define  VTSS_M_UART_UART_MSR_CTS             VTSS_BIT(4)
...
#define  VTSS_M_UART_UART_MSR_DCTS            VTSS_BIT(0)
...
#define  VTSS_M_UART_UART_USR_BUSY            VTSS_BIT(0)
...
//#define VTSS_UART_UART_HTX           VTSS_IOREG(VTSS_TO_UART,0x29)
...
#define  VTSS_M_UART_UART_HTX_HTX             VTSS_BIT(0)
