...
#ifndef _VTSS_OCELOT_REGS_SBA_H_
#define _VTSS_OCELOT_REGS_SBA_H_
 ...
 * bus at the same time, the one with the highest priority is granted bus
 * access.
 *
 * \details 
...
#endif /* _VTSS_OCELOT_REGS_SBA_H_ */
