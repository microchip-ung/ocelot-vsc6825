...
#ifndef _VTSS_OCELOT_REGS_VCAP_CORE_H_
#define _VTSS_OCELOT_REGS_VCAP_CORE_H_
 ...
 * UPDATE_ADDR.
 * Move up operation moves one or more VCAP addresses from a high address
 * to a lower address, this is equivalent to decreasing priority of a rule.
 ...
 * Move down operation moves one or more VCAP addresses from a low address
 * to a higher address, this is equivalent to increasing priority of a
 * rule. This operation is equivalent to "Move up" except for the direction
 * that it moves addresses, see "Move up" for more details.
 ...
 * VCAP supports multiple subwords.
 * This field applies only to version 1 VCAPs, for version 2 VCAPs it is
 * not implemented and reading it will return zeros.
 *
 * \details 
 * Field: ::VTSS_VCAP_CORE_VCAP_CORE_CACHE_VCAP_TG_DAT . TG_DAT
 */
#define  VTSS_F_VCAP_CORE_VCAP_CORE_CACHE_VCAP_TG_DAT_TG_DAT(x)  (x)
#define  VTSS_M_VCAP_CORE_VCAP_CORE_CACHE_VCAP_TG_DAT_TG_DAT     0xffffffff
#define  VTSS_X_VCAP_CORE_VCAP_CORE_CACHE_VCAP_TG_DAT_TG_DAT(x)  (x)
 ...
 * setting this field will first initialize the TCAM and then run BIST.
 *
 * \details 
...
#endif /* _VTSS_OCELOT_REGS_VCAP_CORE_H_ */
