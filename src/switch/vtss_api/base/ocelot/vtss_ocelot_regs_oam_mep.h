 ...
 * Target: \a OAM_MEP
 *
 * The Versatile OAM MEP Processor (VOP) block implements the HW support for
 * implementing OAM MEP.
 * 
 * The VOP consists of 75 Versatile OAM Endpoints (VOE) that each
 * implements an OAM MEP.
 * 
...
#define  VTSS_M_OAM_MEP_COMMON_MEP_CTRL_CCM_LM_UPD_RSV_ENA  VTSS_BIT(14)
...
#define  VTSS_M_OAM_MEP_COMMON_MEP_CTRL_LMR_UPD_RXFCL_ENA  VTSS_BIT(13)
...
#define  VTSS_M_OAM_MEP_COMMON_MEP_CTRL_CCM_SCAN_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_COMMON_MEP_CTRL_MEP_ENA  VTSS_BIT(0)
 ...
 * 
 * The configuration for each OAM PDU consists of two bit fields:
 * 1) *_EXT_PORT_ENA
 ...
 * 
 * OAM_MEP:VOE:BASIC_CTRL.CPU_HITME_ONCE_CCM_TLV
 * 
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_DEF_EXT_PORT_ENA  VTSS_BIT(29)
 ...
 * will be extracted to this queue.
 * 
 * Note, this queue cannot be located on an external front port.
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_CPU_ERR_EXT_PORT_ENA  VTSS_BIT(24)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_DMR_EXT_PORT_ENA  VTSS_BIT(19)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_LMR_EXT_PORT_ENA  VTSS_BIT(14)
 ...
 * using OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6))
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_LBR_EXT_PORT_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_CCM_LM_EXT_PORT_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_1_LT_EXT_PORT_ENA  VTSS_BIT(24)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_1_DMM_EXT_PORT_ENA  VTSS_BIT(19)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_1_LMM_EXT_PORT_ENA  VTSS_BIT(14)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_1_LBM_EXT_PORT_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_COMMON_CPU_CFG_1_CCM_EXT_PORT_ENA  VTSS_BIT(4)
 ...
 * 
 * Note that OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6) is reserved for
 * enabling TST HW processing in the VOE. Hence if forwarding of Generic
 * OpCode(6) is to be used, there must not be TST frames in the frame flow
 * to be handled by the VOE.
 * 
 * Up-MEP:
 ...
 * 
 *   OAM_MEP:VOE:BASIC_CTRL.RX_DMAC_CHK_SEL
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_COMMON_OAM_GENERIC_CFG_GENERIC_DMAC_CHK_DIS  VTSS_BIT(17)
...
#define  VTSS_M_OAM_MEP_COMMON_OAM_GENERIC_CFG_GENERIC_OPCODE_EXT_PORT_ENA  VTSS_BIT(16)
 ...
 * OAM_MEP:VOE:OAM_CPU_COPY_CTRL.GENERIC_COPY_MASK
 * OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK
 * OAM_MEP:VOE:OAM_CNT_OAM_CTRL.GENERIC_OAM_CNT_MASK
 * OAM_MEP:VOE:OAM_CNT_DATA_CTRL.GENERIC_DATA_CNT_MASK
...
/** 
 * \brief
 * Configures Period timers in unit of 198.2 ns
 * 
 * Default: 3.3ms.
 *
 * \details 
 ...
 * 5045409: 1s
 *
 * Field: ::VTSS_OAM_MEP_COMMON_CCM_PERIOD_CFG . CCM_PERIOD_VAL
 */
...
#define  VTSS_M_OAM_MEP_COMMON_CCM_CTRL_CCM_FORCE_HW_SCAN_STOP_ENA  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_COMMON_CCM_SCAN_STICKY_CCM_SCAN_COMPLETED_STICKY  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_COMMON_CCM_SCAN_STICKY_CCM_SCAN_STARTED_STICKY  VTSS_BIT(1)
 ...
 * The confgured Period time in OAM_MEP::CCM_CFG.CCM_PERIOD must be
 * incremented.
 *
 * \details 
 * 0: No event has occurred
...
#define  VTSS_M_OAM_MEP_COMMON_CCM_SCAN_STICKY_CCM_SCAN_START_DELAYED_STICKY  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_COMMON_MASTER_INTR_CTRL_OAM_MEP_INTR_ENA  VTSS_BIT(25)
...
#define  VTSS_M_OAM_MEP_COMMON_MASTER_INTR_CTRL_OAM_MEP_INTR  VTSS_BIT(8)
 ...
 *
 * @param ri Replicator: x_NUM_TOTAL_VOE_DIV32_CEIL (??), 0-1
 */
#define VTSS_OAM_MEP_COMMON_INTR(ri)         VTSS_IOREG(VTSS_TO_OAM_MEP,0xdc6 + (ri))

/** 
 * \brief
 * Status of interrupts per VOE (1 bit per VOE). The interrupts are cleared
 * by clearing the sticky bit set in OAM_MEP:VOE:STICKY or by disabling the
 * interrupt source in OAM_MEP:VOE:INTR_ENA.
 *
 * \details 
 * 0: No interrupt
 * 1: Interrupt asserted
 *
 * Field: ::VTSS_OAM_MEP_COMMON_INTR . CCM_INTR
 */
 ...
 *
 * @param ri Replicator: x_NUM_VOE (??), 0-31
 */
...
#define  VTSS_M_OAM_MEP_COMMON_VOE_CFG_UPMEP_VOE  VTSS_BIT(0)
 ...
 * 
 * OAM_MEP:VOE:CCM_CAP_RX_FCL.CCM_CAP_RX_FCL
 * 
 ...
 * 
 * OAM_MEP:VOE:UPMEP_LM_CNT_STICKY.CCM_LM_RX_CNT_STICKY
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_COMMON_UPMEP_LM_CNT_VLD_CCM_LM_RX_CNT_VLD  VTSS_BIT(2)
 ...
 * LM counter and saved the value into the following register:
 * 
 * OAM_MEP:VOE:UPMEP_LMR_RX_LM_CNT.UPMEP_LMR_RX_LM_CNT
 * 
 ...
 * RX_LM sample was lost.
 * 
 * OAM_MEP:VOE:UPMEP_LM_CNT_STICKY.LMM_RX_CNT_STICKY
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_COMMON_UPMEP_LM_CNT_VLD_LMM_RX_CNT_VLD  VTSS_BIT(1)
 ...
 * LM counter and saved the value into the following register:
 * 
 * OAM_MEP:VOE:CCM_CAP_TX_FCF.CCM_CAP_TX_FCF
 * 
 ...
 * RX_LM sample was lost:
 * 
 * OAM_MEP:VOE:UPMEP_LM_CNT_STICKY.LMR_RX_CNT_STICKY
...
#define  VTSS_M_OAM_MEP_COMMON_UPMEP_LM_CNT_VLD_LMR_RX_CNT_VLD  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_COMMON_VOE_MAP_CTRL_PATH_VOEID_ENA  VTSS_BIT(0)
 ...
 *
 * @param ri Replicator: x_NUM_TOTAL_VOE (??), 0-42
 */
...
#define  VTSS_M_OAM_MEP_COMMON_VOE_CNT_CTRL_CNT_YELLOW_ENA  VTSS_BIT(8)
 ...
 * 
 * If priority bit is not set in MASK the priority will be counted as
 * priority 7.
 * 
 * The priority mask is respected by a Service VOE when updating any
 * configured Path VOE and the Port VOE on frame reception / transmission.
 * Hence the Service VOE will look at the PRIO_CNT_MASK for any configured
 * Path VOE and the Port VOE and update their LM counters according to the
 ...
 * 1) OAM_MEP:COMMON:COMMON_MEP_MC_MAC_LSB
 * 2) OAM_MEP:COMMON:COMMON_MEP_MC_MAC_MSB
 * 
 ...
 *
 * Configuration per Microchip OAM MEP Endpoints (VOE)
 */
 ...
 *
 * @param gi Replicator: x_NUM_TOTAL_VOE (??), 0-42
 */
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_MAC_ADDR_ERR_REDIR_ENA  VTSS_BIT(10)
 ...
 * See OAM_MEP:COMMON:OAM_GENERIC_CFG.GENERIC_DMAC_CHK_DIS
 ...
 * extraction queue OAM_MEP:COMMON:CPU_CFG.DEF_COPY_QU.
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_CPU_HITME_ONCE_CCM_TLV  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_CCM_ERR_CPU_HITME_ONCE  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_CCM_ERR_CPU_COPY_ENA  VTSS_BIT(5)
 ...
 * configuration in OAM_MEP::CPU_CFG_1.CCM_CPU_QU
 *
 * \details 
 * 0: Disable (no CPU hitme once copy)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_CCM_NXT_CPU_HITME_ONCE  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_MIP_UNICAST_ONLY_COPY_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_VOE_AS_MIP_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_VOE_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_BASIC_CTRL_UPMEP_KILL_ALL_RX  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_UPMEP_LB  VTSS_BIT(16)
...
/** 
 * \brief
 * Configures if the first OAM PDU discarded due to being received from a
 * port not set in the MEP_PORTMASK is copied to the CPU extraction queue
 * configured in OAM_MEP::CPU_CFG.CPU_ERR_QU.

 *
 * \details 
 * 0: Disable (no CPU hit me once copy)
 * 1: Enable the next frame failing the MEP direction check to be sent to
 * CPU
 * 
 * The bit is cleared by HW when a CPU copy has been made.
 *
 * Field: ::VTSS_OAM_MEP_VOE_MEL_CTRL . CPU_HITME_ONCE_MEP_DIR_BLOCK
 */
#define  VTSS_F_OAM_MEP_VOE_MEL_CTRL_CPU_HITME_ONCE_MEP_DIR_BLOCK(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_CPU_HITME_ONCE_MEP_DIR_BLOCK  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_CPU_HITME_ONCE_MEL_TOO_LOW  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_CPU_COPY_MEL_TOO_LOW  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_CPU_HITME_ONCE_CCM_MEL_TOO_LOW  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_MEL_CTRL_CPU_COPY_CCM_MEL_TOO_LOW  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_UNK_OPCODE_CPU_COPY_ENA  VTSS_BIT(11)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LTM_CPU_COPY_ENA  VTSS_BIT(10)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LTR_CPU_COPY_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LMM_CPU_COPY_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LMR_CPU_COPY_ENA  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LBM_CPU_COPY_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_LBR_CPU_COPY_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_DMM_CPU_COPY_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_DMR_CPU_COPY_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_SM_CPU_COPY_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_CCM_CPU_COPY_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CPU_COPY_CTRL_CCM_LM_CPU_COPY_ENA  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LTM_FWD_ENA  VTSS_BIT(10)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LTR_FWD_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LMM_FWD_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LMR_FWD_ENA  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LBM_FWD_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_LBR_FWD_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_DMM_FWD_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_DMR_FWD_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_SM_FWD_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_CCM_FWD_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_FWD_CTRL_CCM_LM_FWD_ENA  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_SDLB_CTRL_OAM_SDLB_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_UNK_OPCODE_OAM_CNT_ENA  VTSS_BIT(11)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LTM_OAM_CNT_ENA  VTSS_BIT(10)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LTR_OAM_CNT_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LMM_OAM_CNT_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LMR_OAM_CNT_ENA  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LBM_OAM_CNT_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_LBR_OAM_CNT_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_DMM_OAM_CNT_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_DMR_OAM_CNT_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_SM_OAM_CNT_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_CCM_OAM_CNT_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_OAM_CTRL_CCM_LM_OAM_CNT_ENA  VTSS_BIT(0)
 ...
 * 
 * Service VOE:
 * OAM_MEP:RX_VOE_PM:MEP_RX_FRM_CNT
 * OAM_MEP:TX_VOE_PM:MEP_TX_FRM_CNT
 * 
 * Port VOE:
 * PORT_RX_FRM_CNT.RX_FRM_CNT
 * PORT_TX_FRM_CNT.TX_FRM_CNT
 *
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_UNK_OPCODE_DATA_CNT_ENA  VTSS_BIT(10)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LTM_DATA_CNT_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LTR_DATA_CNT_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LMM_DATA_CNT_ENA  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LMR_DATA_CNT_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LBM_DATA_CNT_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_LBR_DATA_CNT_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_DMM_DATA_CNT_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_DMR_DATA_CNT_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_SM_DATA_CNT_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_CNT_DATA_CTRL_CCM_DATA_CNT_ENA  VTSS_BIT(0)
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_MEP_UC_MAC_LSB . MEP_UC_MAC_LSB
 */
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_LMM_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_LMR_ENA  VTSS_BIT(7)
 ...
 * handling is enabled using OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6)).
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_OAM_HW_CTRL . LBM_ENA
 */
#define  VTSS_F_OAM_MEP_VOE_OAM_HW_CTRL_LBM_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_LBM_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_LBR_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_DMM_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_DMR_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_SDM_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_CCM_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_HW_CTRL_CCM_LM_ENA  VTSS_BIT(0)
 ...
 *
 * \details 
 * 0: OAM LMM PDU is sent to CPU queue: OAM_MEP::CPU_CFG_1.LMM_CPU_QU
...
#define  VTSS_M_OAM_MEP_VOE_LOOPBACK_CTRL_LB_LMM_ENA  VTSS_BIT(21)
 ...
 *
 * \details 
 * 0: OAM DMM PDU is sent to CPU queue: OAM_MEP::CPU_CFG_1.LMM_CPU_QU
...
#define  VTSS_M_OAM_MEP_VOE_LOOPBACK_CTRL_LB_DMM_ENA  VTSS_BIT(20)
...
/** 
 * \brief
 * This register is used for Down-MEP implementations only (has no effect
 * for Up-MEP).
 * 
 * For a VOE implementing an unprotected Service MEP, this register must be
 * configured to the VOE PORT (The port on which the VOE is located)
 * 
 * For a VOE implementing a protected service MEP, this register must be
 * programmed with the port number of the protect port.
 *
 * \details 
...
/** 
 * \brief
 * Number of RX LBR frames.
 * 
 * Note:
 * Also used to count number of RX TST frames (If TST frames are enabled
 * using OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6)).
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_LBR_RX_FRM_CNT . LBR_RX_FRM_CNT
 */
 ...
 * OAM_MEP:VOE:OAM_RX_STICKY.LBR_TRANSID_ERR_STICKY.
 *
...
/** 
 * \brief
 * Configures one less than next expected Transaction ID. Used for checking
 * the LBR transaction ID. 
 * 
 * Updated by Hardware to received OAM PDU transaction ID.
 * 
 * Note:
 * Also updated for RX TST frames (If TST frames are enabled using
 * OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6)).
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_LBR_RX_TRANSID_CFG . LBR_RX_TRANSID
 */
...
#define  VTSS_M_OAM_MEP_VOE_LBM_TX_TRANSID_UPDATE_LBM_TRANSID_UPDATE_ENA  VTSS_BIT(0)
...
/** 
 * \brief
 * Configures one less than transmitted transaction ID for LBM.
 * 
 * Auto incremented by hardware upon usage.
 * 
 * Note:
 * Also used to update Tx TST frames (If TST frames are enabled using
 * OAM_MEP:VOE:OAM_FWD_CTRL.GENERIC_FWD_MASK(6))).
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_LBM_TX_TRANSID_CFG . LBM_TX_TRANSID
 */
 ...
 * 
 * Automatically set by hardware every time CCM_LM_PERIOD has occurred.
 * 
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_LM_INSERT_NXT  VTSS_BIT(23)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_SEQ_INCR_ENA  VTSS_BIT(22)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_SEQ_UPD_ENA  VTSS_BIT(21)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_RX_SEQ_CHK_ENA  VTSS_BIT(20)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_TX_RDI  VTSS_BIT(19)
 ...
 * configured by OAM_MEP::CCM_CTRL.
 *
 * \details 
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_MEGID_CHK_ENA  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_MEPID_CHK_ENA  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_PERIOD_ERR  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_PRIO_ERR  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_ZERO_PERIOD_ERR  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_RX_RDI  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_LOC_DEFECT  VTSS_BIT(3)
 ...
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_MEPID_CHK_ENA = 1
 *
 * \details 
 * 0: No MEPID err
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_MEPID_ERR  VTSS_BIT(2)
 ...
 * value configured in: 
 * 
 * OAM_MEP:VOE:CCM_MEGID_CFG.CCM_MEGID.
 * 
 * MEGID checking is enabled by:
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_MEGID_CHK_ENA = 1
 *
 * \details 
 * 0: No MEGID err
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_CCM_MEGID_ERR  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_CCM_CFG_OAM_MEL_ERR  VTSS_BIT(0)
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_RX_VLD_FC_CNT . CCM_RX_VLD_FC_CNT
 */
 ...
 * and therefore does not clear the CCM miss counter.
 *
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_RX_INVLD_FC_CNT . CCM_RX_INVLD_FC_CNT
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_CAP_TX_FCF . CCM_CAP_TX_FCF
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_CAP_RX_FCL . CCM_CAP_RX_FCL
 */
 ...
 * arrives, the following sticky bit is asserted:
 * 
 *     UPMEP_LM_CNT_STICKY.LMR_RX_CNT_STICKY
 *
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_UPMEP_LMR_RX_LM_CNT . UPMEP_LMR_RX_LM_CNT
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_TX_SEQ_CFG . CCM_TX_SEQ
 */
 ...
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_RX_SEQ_CHK_ENA = 1
 * 
 ...
 * \brief
 * Down-MEP:
 * Configures CCM RX SEQ.
 * 
 * Up-MEP:
 * Holds the values of the RX_LM_SN for OAM LM frames.
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_RX_SEQ_CFG . CCM_RX_SEQ
 */
 ...
 * signaled using the following error bit:
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_MEPID_ERR
 *
 * \details 
...
/** 
 * \brief
 * Configures the MEG ID to be used for CCM checking. 
 * 
 * The checking is enabled by setting: 
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_MEGID_CHK_ENA = 1
 * 
 * Any errors in the incoming MEG ID are reported in error bit:
 * 
 * OAM_MEP:VOE:CCM_CFG.CCM_MEGID_ERR

 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_CCM_MEGID_CFG . CCM_MEGID
 */
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_UNK_OPCODE_RX_STICKY  VTSS_BIT(16)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LTM_RX_STICKY  VTSS_BIT(15)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LTR_RX_STICKY  VTSS_BIT(14)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LMM_RX_STICKY  VTSS_BIT(13)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LMR_RX_STICKY  VTSS_BIT(12)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LBM_RX_STICKY  VTSS_BIT(11)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LBR_RX_STICKY  VTSS_BIT(10)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_DMM_RX_STICKY  VTSS_BIT(9)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_DMR_RX_STICKY  VTSS_BIT(8)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_SM_RX_STICKY  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_CCM_RX_STICKY  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_CCM_LM_RX_STICKY  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_LBR_TRANSID_ERR_STICKY  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_CCM_RX_SEQ_ERR_STICKY  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_OAM_AS_DATA_STICKY  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_MEP_EGR_BLOCK_STICKY  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_OAM_RX_STICKY_MAC_ADDR_ERR_STICKY  VTSS_BIT(0)
 ...
 * \details 
 * 0: No event
 * 1: Changed non-zero Period occurred
 *
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_PERIOD_STICKY  VTSS_BIT(7)
 ...
 * \details 
 * 0: No event
 * 1: Changed CCM Priority occurred
 *
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_PRIO_STICKY  VTSS_BIT(6)
 ...
 * \details 
 * 0: No event
 * 1: Changed Zero Period occurred
 *
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_ZERO_PERIOD_STICKY  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_RX_RDI_STICKY  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_LOC_STICKY  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_MEPID_STICKY  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_CCM_MEGID_STICKY  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_STICKY_OAM_MEL_STICKY  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_UPMEP_LM_CNT_STICKY_CCM_LM_RX_CNT_STICKY  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_UPMEP_LM_CNT_STICKY_LMM_RX_CNT_STICKY  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_UPMEP_LM_CNT_STICKY_LMR_RX_CNT_STICKY  VTSS_BIT(0)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_PERIOD_INTR_ENA  VTSS_BIT(7)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_PRIO_INTR_ENA  VTSS_BIT(6)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_ZERO_PERIOD_INTR_ENA  VTSS_BIT(5)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_RX_RDI_INTR_ENA  VTSS_BIT(4)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_LOC_INTR_ENA  VTSS_BIT(3)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_MEPID_INTR_ENA  VTSS_BIT(2)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_CCM_MEGID_INTR_ENA  VTSS_BIT(1)
...
#define  VTSS_M_OAM_MEP_VOE_INTR_ENA_OAM_MEL_INTR_ENA  VTSS_BIT(0)
 ...
 * 
 * Selected OAM PDUs are configured in OAM_MEP:VOE:OAM_CNT_OAM_CTRL.*
 *
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_RX_SEL_OAM_CNT . RX_SEL_OAM_FRM_CNT
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_RX_OAM_FRM_CNT . RX_OAM_FRM_CNT
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_TX_SEL_OAM_CNT . TX_SEL_OAM_FRM_CNT
 */
 ...
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_VOE_TX_OAM_FRM_CNT . TX_OAM_FRM_CNT
 */
...
/** 
 * \brief
 * Rx LM frame counters per port VOE per priority.
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_PORT_PM_PORT_RX_FRM_CNT . RX_FRM_CNT
 */
...
/** 
 * \brief
 * Tx LM frame counters per port VOE per priority.
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_PORT_PM_PORT_TX_FRM_CNT . TX_FRM_CNT
 */
 ...
 *
 * @param gi Replicator: x_NUM_VOE_x_NUM_PRIO (??), 0-255
 */
#define VTSS_OAM_MEP_RX_VOE_PM_MEP_RX_FRM_CNT(gi)  VTSS_IOREG_IX(VTSS_TO_OAM_MEP,0xb00,gi,1,0,0)

/** 
 * \brief
 * RX LM frame counters by VOE.
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_RX_VOE_PM_MEP_RX_FRM_CNT . RX_FRM_CNT
 */
...
/** 
 * \brief
 * Tx LM frame counters.
 *
 * \details 
 * Field: ::VTSS_OAM_MEP_TX_VOE_PM_MEP_TX_FRM_CNT . TX_FRM_CNT
 */
